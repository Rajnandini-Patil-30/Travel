...
function Navbar(){
  ...
  <div className="container-fluid">
    <Link className="navbar-brand" to="#">Travel Project</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/tourists">Tourist</Link>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="#">Stats</Link>
        </li>
        <li className="nav-item">
